...
subplot(2, 1, 1)
    plot(D.data(D.zz).signalClips(1:2048, 1) + 300);
    hold on;
    plot(D.data(D.zz).signalClips(1:2048, 2) + 100);
    plot(D.data(D.zz).signalClips(1:2048, 3) - 100);
    plot(D.data(D.zz).signalClips(1:2048, 4) - 300);
    xlim([0, 2048]);
    ylim([-1000, 1000]);
    ...
    if D.data(D.zz).responses == 0
        patch([1024 - (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 - (.5*D.data(D.zz).seizureDuration)], [-1000, -1000, 1000, 1000], 'y', 'FaceColor', 'y', 'FaceAlpha', .25, 'EdgeColor', 'none');
    elseif D.data(D.zz).responses == 1
        patch([1024 - (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 - (.5*D.data(D.zz).seizureDuration)], [-1000, -1000, 1000, 1000], 'r', 'FaceColor', 'r', 'FaceAlpha', .25, 'EdgeColor', 'none');
    elseif D.data(D.zz).responses == 2
        patch([1024 - (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 - (.5*D.data(D.zz).seizureDuration)], [-1000, -1000, 1000, 1000], 'g', 'FaceColor', 'g', 'FaceAlpha', .25, 'EdgeColor', 'none');
    end
    hold off;
    ...
    xlabel('Time (s)')
subplot(2, 1, 2)
    plot(D.data(D.zz).icaSignal(:, 1) + 9);
    hold on;
    plot(D.data(D.zz).icaSignal(:, 2) + 3);
    plot(D.data(D.zz).icaSignal(:, 3) - 3);
    plot(D.data(D.zz).icaSignal(:, 4) - 9);
    xlim([0, 2048]);
    ylim([-20, 20]);
    %text(100, 800, strcat({'Event '}, num2str(D.zz)), 'Color', 'k'); % 256 is at 1 second (remember I change the scale below)
    if D.data(D.zz).responses == 0
        patch([1024 - (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 - (.5*D.data(D.zz).seizureDuration)], [-20, -20, 20, 20], 'y', 'FaceColor', 'y', 'FaceAlpha', .25, 'EdgeColor', 'none');
    elseif D.data(D.zz).responses == 1
        patch([1024 - (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 - (.5*D.data(D.zz).seizureDuration)], [-20, -20, 20, 20], 'r', 'FaceColor', 'r', 'FaceAlpha', .25, 'EdgeColor', 'none');
    elseif D.data(D.zz).responses == 2
        patch([1024 - (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 + (.5*D.data(D.zz).seizureDuration), 1024 - (.5*D.data(D.zz).seizureDuration)], [-20, -20, 20, 20], 'g', 'FaceColor', 'g', 'FaceAlpha', .25, 'EdgeColor', 'none');
    end
    hold off;
    ylabel('ICA amplitude');
...
D = handles.D;
save(strcat(handles.athname, handles.filename), 'D')
